    ...
    const handleSubmit = async(event, elements, stripe) => {
        ...
        if(error) {
            ...
            const orderData = {
                ...
                coustomer: {firstname: shippingData.firstname, lastname: shippingData, email: shippingData.email },
                shipping: {
                    name: 'Primary', 
                ...
                <ElementsConsumer>
                    {({ elements, stripe }) => ( 
                        <form onSubmit={(e) => handleSubmit(e, elements, stripe)}>
                            <CardElement/>
                            <Typography variant='body2' color='secondary'>(use '42' repating as credit card info to test site)</Typography>
                            <br/> <br/> 
